...
$planes = [
    ...
    'premium_plus' => [
        ...
        'precio_mes' => 49.99,
        'precio_ano' => 39.99,
        'descripcion'=> 'Plan exclusivo para concesionarias y dealers profesionales',
        'color'      => 'purple',
        'cta'        => 'Activar con código Dealer',
        'cta_link'   => '#codigo-promo',
        'featured'   => false,
        'items' => [
            ['ok'=>true, 'txt'=>'Publicaciones ilimitadas'],
...
$comparativa = [
    ...
    'Badge'               => ['Destacado',  'Premium',    'Dealers'],
...
$faq = [
    ...
    ['p'=>'Que metodos de pago aceptan?',        'r'=>'Aceptamos tarjetas de crédito/débito (Visa, Mastercard, Amex) y transferencias bancarias en Argentina.'],
    ['p'=>'Como accedo al plan Dealers?',         'r'=>'El plan Dealers se activa exclusivamente con un código promocional. Contactanos para obtener tu código y disfrutar 30 días gratis.'],
    ['p'=>'Como funciona la publicidad en redes?','r'=>'Con el plan Dealers publicamos tus vehículos destacados en nuestras redes sociales de forma constante durante la vigencia de tu plan.'],
